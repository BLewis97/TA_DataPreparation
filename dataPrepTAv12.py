...
def average_decay(data, x=-1000, y=-1, units='ns', label='label me', 
    ...
    print('')
    print('Always Good to check if you have selected the GSB rather than PIA!')
    print('Try using ta.plot_spec to see which sign your bleach is (should be +ve and roughly where absorption onset is)')
